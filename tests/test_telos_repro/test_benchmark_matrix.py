"""Tests for :mod:`telos_repro.benchmark.matrix` (bundle root resolution and YAML mapping)."""
...
class TestBenchmarkMatrix(unittest.TestCase):
    def test_cross_annotation_train_test(self) -> None:
        ...
        self.assertEqual(m.get("schema_version"), 3)
        self.assertEqual(m["analysis"].get("benchmark_mode"), "minimal")
        ...
        self.assertIsNone(pr.get("gffcompare_bin"))
