...
Usage::
    ...
    PYTHONPATH=src_v2 python src_v2/experiments/plot_stage1_feature_importance_gencode.py
...
def plot_top_features_facets(
    ...
    *,
    ...
    """Delegate to stacked PDF plotter in ``telos_v2.plotting.feature_window_plots``."""
    from telos_v2.plotting.feature_window_plots import plot_feature_importance_stacked
...
def main() -> int:
    ...
    try:
        ...
        from telos_v2.plotting.feature_window_plots import (
