...
# isoquant.py --threads 32 --model_construction_strategy all --reference $ref_genome --bam "$bam_file" --data_type nanopore -o $isoquant_out
...
isoquant.py --threads 32 --reference $ref_genome --bam "$bam_file" --data_type nanopore -o $isoquant_out
