...
Usage::
    ...
    PYTHONPATH=src python src/experiments/stage1_feature_importance_gencode.py

    # Re-summarize only (benchmarks and cache must already exist)
    PYTHONPATH=src python src/experiments/stage1_feature_importance_gencode.py --importance-only

    # Skip permutation (faster; built-in importances only)
    PYTHONPATH=src python src/experiments/stage1_feature_importance_gencode.py --no-permutation
"""
...
from telos_repro.analysis.stage1_importance import (
...
from telos_repro.benchmark.matrix import resolve_bundles_root, run_benchmark_matrix
...
from telos.models.stage1_train import load_stage1_bundle
from telos.pipeline_core import build_stage1_runtime_config, stage1_cache_dir_for
from telos.models import STAGE1_BACKENDS, stage1_bundle_path
from telos.models.chrom_split import parse_split_policy, split_train_val_masks
