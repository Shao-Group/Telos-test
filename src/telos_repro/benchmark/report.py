...
from telos_repro.benchmark.util import round_float_metrics_in_row
...
def stub_test_row(
    ...
    *,
    ...
    """
    Build a minimal result row when a test entry cannot be turned into a :class:`~telos.config_models.PredictIO`.

    Fills empty paths and ``predict_code=2``; applies :func:`~telos_repro.benchmark.util.round_float_metrics_in_row`.
    """
    row: dict[str, Any] = {
        "test_id": test_id,
        "assembler_id": "",
