"""
Glue between :mod:`telos_repro.benchmark.orchestrator` and :mod:`telos_repro.evaluation.transcript_pr_pipeline`.
...
def run_backend_transcript_pr(
    *,
    ...
    """
    Run :func:`~telos_repro.evaluation.transcript_pr_pipeline.run_transcript_pr_benchmark` with benchmark defaults.
